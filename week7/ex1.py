...
mickey = pygame.image.load('imagesformickey/main-clock.png')
leftHand = pygame.image.load('imagesformickey/left-hand.png')
rightHand = pygame.image.load('imagesformickey/right-hand.png')
